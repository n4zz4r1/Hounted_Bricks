...
public class CardSlotFSM : StateMachine<CardSlotFSM, State<CardSlotFSM>> {
    ...
    protected override async Task BeforeAsync() {
        ...
        CardPrefabDictionary.Add(Card.Card_001_Crooked_Rock, await AssetLoader<CardFSM, ResourceType>.LoadCardFSM(Card.Card_001_Crooked_Rock));
        CardPrefabDictionary.Add(Card.Card_002_Rounded_Rock, await AssetLoader<CardFSM, ResourceType>.LoadCardFSM(Card.Card_002_Rounded_Rock));
        CardPrefabDictionary.Add(Card.Card_003_Arrowed_Rock, await AssetLoader<CardFSM, ResourceType>.LoadCardFSM(Card.Card_003_Arrowed_Rock));
        CardPrefabDictionary.Add(Card.Card_004_Bomb_Rock, await AssetLoader<CardFSM, ResourceType>.LoadCardFSM(Card.Card_004_Bomb_Rock));
